...
#define X_STEP_PIN          GPIO_NUM_47 // NO TOUCH !!
#define Y_STEP_PIN          GPIO_NUM_38 // NO TOUCH !!
#define Z_STEP_PIN          GPIO_NUM_40
#define E_STEP_PIN          GPIO_NUM_42

//#define Y_STEP_PIN          GPIO_NUM_38
//#define Z_STEP_PIN          GPIO_NUM_40
//#define E_STEP_PIN          GPIO_NUM_42

#define X_DIR_PIN           GPIO_NUM_21 //
#define Y_DIR_PIN           GPIO_NUM_39 //
#define Z_DIR_PIN           GPIO_NUM_41
#define E_DIR_PIN           GPIO_NUM_2

//#define Y_DIR_PIN           GPIO_NUM_37
//#define Z_DIR_PIN           GPIO_NUM_39
//#define E_DIR_PIN           GPIO_NUM_41
